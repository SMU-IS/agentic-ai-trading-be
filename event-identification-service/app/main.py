...
metrics = MetricsTracker(async_redis, "eventidentification")

app = FastAPI(
    title="Event Identification Service",
    description="API Service",
    root_path="/api/v1/event-identification",
)
...
def health_check():
    try:
        ...
        active_workers = [
            key.replace("eventidentification:heartbeat:", "") for key in heartbeat_keys
        ]
