...
async def test_trade_history_node_finds_order_by_ticker():
    ...
    mock_extracted = TradeHistorySearch(
        ticker="GOOGL", after="2026-03-27", until="2026-04-03"
    )
    ...
    llm.ainvoke = AsyncMock(
        return_value=AIMessage(content="I sold GOOGL because RSI was overbought")
    )
    ...
    with patch(
        "app.services.ai_agent.nodes.trade_history._get_trade_history_list",
