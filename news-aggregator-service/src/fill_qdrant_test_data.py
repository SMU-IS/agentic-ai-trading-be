...
async def fill_qdrant_tickers():
    ...
    try:
        ...
        print(f"✅ Created '{collection_name} or {e}'")
    ...
    for ticker in ["TSLA", "AAPL", "AVAV"]:
        ...
        results = client.scroll(
            collection_name=collection_name, scroll_filter=filter_ticker, limit=3
        )
        points, _ = results
